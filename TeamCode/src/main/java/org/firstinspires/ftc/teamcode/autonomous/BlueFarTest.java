...
public class BlueFarTest extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Actions.runBlocking(new SequentialAction( //overall sequential action that continues for length of Auton
                ...
                new ParallelAction(
                        Turntoshootload1,
                        new SleepAction(3) //placeholder for spinning up launcher
                ),
                ...
                new ParallelAction(
                        Intakeload2,
                        new SleepAction(1)// place holder for spinning intake              ;D
                ),
                ...
                new ParallelAction(
                        Getload3,
                        new SleepAction(1)//placeholder for spinning intake
                ),
                ...
                new ParallelAction(
                        Shootload3,
                        new SleepAction(3)//place holder for spinning up the launcher
                ),
