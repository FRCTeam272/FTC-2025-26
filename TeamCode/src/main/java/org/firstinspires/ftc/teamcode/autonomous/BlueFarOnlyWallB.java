...
public class BlueFarOnlyWallB extends LinearOpMode {
    ...
    double launchX = 53;
    double launchY = -15;
    double launchH = Math.toRadians(Constants.Util.angleToBlueGoalDegrees(launchX, launchY)-5.5);
