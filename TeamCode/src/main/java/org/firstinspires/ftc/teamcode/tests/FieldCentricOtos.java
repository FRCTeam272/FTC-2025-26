...
@TeleOp
public class FieldCentricOtos extends OpMode {
    ...
    public void loop() {
        ...
        telemetry.addData("Robot Y: ", myOtos.getPosition().y);
        telemetry.addData("Robot H: ", myOtos.getPosition().h);
        telemetry.addLine("Press Y to reset tracking");
        telemetry.addLine("Hold LeftBumper for 50% speed");
        telemetry.update();
