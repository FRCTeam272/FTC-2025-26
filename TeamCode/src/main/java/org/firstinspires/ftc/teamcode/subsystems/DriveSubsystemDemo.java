...
public class DriveSubsystemDemo {
    ...
    public final double driveSpeed = 0.4;
...
//    public final double slowSpeed = 0.2;
    ...
    public DriveSubsystemDemo(HardwareMap hardwareMap, MatchSettings matchSettings) {
    ...
    public void runManualMecanumDrive(double forward, double strafe, double rotate, boolean yButton) {
