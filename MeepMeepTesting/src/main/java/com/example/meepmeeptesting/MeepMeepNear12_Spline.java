...
public class MeepMeepNear12_Spline {
    public static void main(String[] args) {
        ...
        double launchX = -12;
        double launchY = 12;
        double launchH = Math.toRadians(Util.angleToRedGoalDegrees(launchX, launchY) +180);

        // Launch Position Load1
        double launch1X = -12;
        double launch1Y = 12;
        double launch1H = Math.toRadians(Util.angleToRedGoalDegrees(launch1X, launch1Y));

        // Launch Position Load2
        double launch2X = -12;
        double launch2Y = 12;
        double launch2H = Math.toRadians(Util.angleToRedGoalDegrees(launch2X, launch2Y));

        // Launch Position Load3
        double launch3X = -12;
        double launch3Y = 12;
        double launch3H = Math.toRadians(Util.angleToRedGoalDegrees(launch3X, launch3Y));
        ...
        double avoidGateH = Math.toRadians(90); //Red=90, Blue=270
